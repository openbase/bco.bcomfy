...
public class ColorableLightSelectorHolder extends AbstractUnitSelectorHolder {
    ...
    public ColorableLightSelectorHolder(UnitConfigType.UnitConfig unitConfig, boolean isMainSelector) throws InterruptedException, ExecutionException, NotAvailableException, TimeoutException {
